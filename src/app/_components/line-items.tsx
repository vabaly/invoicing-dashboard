...
import { InvoiceWithClient } from "~/business";
import i18n from "~/i18n";

export function LineItems ({ lineItems }: { lineItems: InvoiceWithClient['lineItems'] }) {
  return (
      ...
      <TableHead>
        ...
        <TableRow>
          ...
          <TableCell align="right">
            {i18n.t('lineItem.price')}
          </TableCell>
          <TableCell align="right">
            {i18n.t('lineItem.quantity')}
          </TableCell>
        </TableRow>
      </TableHead>
